...
----------------系统设置------------------------
SELECT * FROM dbo.T_TableDescription WHERE FDescription LIKE '%产品%'; --系统表
SELECT * FROM dbo.T_TableDescription WHERE FDescription LIKE '%物料%'; --系统表
SELECT * FROM dbo.T_TableDescription WHERE FTableName LIKE '%t_accessory%'; --系统表
...
SELECT * FROM dbo.T_FieldDescription WHERE FFieldName LIKE '%FBatchNo%'; --字段表
